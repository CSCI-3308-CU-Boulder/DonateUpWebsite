...
function enableButton(letter, capital, number, length, match) {
    ...
    var letter_true = letter.classList.value == "valid";
    var capital_true = capital.classList.value == "valid";
    var number_true = number.classList.value == "valid";
    var length_true = length.classList.value == "valid";
    var match_true = match.classList.value == "valid";

    var condition = (letter_true && capital_true && number_true && length_true && match_true); // TODO: Replace false with the correct condition
    if(condition) {       
